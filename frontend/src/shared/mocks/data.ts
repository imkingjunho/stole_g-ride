...
export const mockRideRequest: Schemas['RideRequestDetail'] = {
  ...
  destLat: 35.1378,
  destLng: 126.7902,
  departAt: '2026-10-20T08:30:00+09:00',
  expiresAt: '2026-10-20T08:40:00+09:00',
  maxWaitMin: 10,
  sameGenderOnly: true,
  maxDetourRatio: 0.2,
  soloDistance: 10591,
  ...
  estimated: true,
  groupId: null,
  createdAt: '2026-10-20T08:30:00+09:00',
};
...
export const mockGroup: Schemas['GroupDetail'] = {
  ...
  acceptDeadline: null,
  createdAt: '2026-10-20T08:31:00+09:00',
};
...
export const mockMessages: Schemas['ChatMessage'][] = [
  ...
  },
  {
    ...
    createdAt: '2026-10-20T08:31:30+09:00',
  },
];
...
export const mockHistory: Schemas['HistoryPage'] = {
  content: [
    {
      groupId: 17,
      ridedAt: '2026-10-20T08:55:00+09:00',
      hubName: '전남대 후문',
      destName: '광주송정역',
      memberCount: 3,
      shareAmount: 9750,
